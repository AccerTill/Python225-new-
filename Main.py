...
#               f'{self.get_width()}, background: {self.background}')
#
#
...
#
#     @abstractmethod              # --------- реализуются в дочерних классах.
#     def move(self):
...
#
# out = MyOuter('Внешний.')
# inner = out.MyInner("Внутренний.", out) #--- FIRST METHOD
# print(inner.inner_name, "%%%")
# inner.inner_method()
#
# f=MyOuter.MyInner("kelly", 23) #--- SECOND METHOD
# print(f.inner_name)
