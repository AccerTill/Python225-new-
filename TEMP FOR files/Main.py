...
#     cur = con.cursor()
#     # cur.execute("""
#                           # executescript только для запроса ниже !!!!!
#     cur.executescript("""
#     CREATE TABLE IF NOT EXISTS cars (
#         cars_id INTEGER PRIMARY KEY AUTOINCREMENT,
#         model TEXT,
...
#
#     BEGIN;
#     INSERT INTO cars VALUES(NULL, 'HONDA', 22211);
#     UPDATE cars2 SET price = price + 100;
#     """)
#
# # BEGIN для rollback
...
#     if con:
#         con.rollback()
#         print("Error of perfoming request!!!")
#
# finally:
#     if con:
#         con.close()
...
#     cur.execute("INSERT INTO cars VALUES(1, 'Volvo', 20000)")
#     cur.execute("INSERT INTO cars VALUES(2, 'BMW', 22040)")
#     cur.execute("INSERT INTO cars VALUES(3, 'FIAT', 29300)")
#     cur.execute("INSERT INTO cars VALUES(4, 'AUDI', 21900)")
#     cur.execute("INSERT INTO cars VALUES(5, 'LOTUS', 22088)")
